...
@Tag(
        name = "CRUD REST APIs for Accounts in MicroFin-Suite",
        description = "CRUD REST APIs in MicroFin-Suite to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside MicroFin-Suite"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
